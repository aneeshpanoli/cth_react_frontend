  ...
  return (
    <Box>
      <Container>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to CivicTechHub, Hovestraat 148, 2650
              Edegem, Belgium.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to CivicTechHub, accessible from{" "}
              <a
                href="http://www.civictechhub.org"
                rel="external nofollow noopener"
                target="_blank"
              >
                http://www.civictechhub.org
              </a>
            </p>
          </li>
          <li>
        ...
        <p>
          <em>Thank you for using CivicTechHub.</em>
        </p>
      </Container>
    </Box>
  );
